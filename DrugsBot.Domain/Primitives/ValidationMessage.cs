...
public static class ValidationMessage
{
    ...
    public const string InvalidFormat = "Формат значения в поле {PropertyName} неверный.";
    public const string InvalidEmailMessage  = "Значение {PropertyName} не является электронной почтой.";
}